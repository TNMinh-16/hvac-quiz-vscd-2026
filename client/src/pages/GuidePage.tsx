      ...
      <div className="container-wide">
        ...
        <div className="hero-banner" style={{ background: 'linear-gradient(135deg, var(--clr-primary-800) 0%, var(--clr-primary-600) 50%, var(--clr-accent-700) 100%)', marginBottom: '2rem' }}>
          ...
          <div className="hero-sub" style={{ maxWidth: '720px', marginBottom: '1.25rem' }}>
            {isVi 
              ? 'Cẩm nang toàn diện giúp bạn tối ưu thời gian ôn thi các tiêu chuẩn ASHRAE 52.2, 52.2-2017, 55, 62.1, 62.1-2022 và 90.1 với 439 câu hỏi ngân hàng chính thức VSCD 2026.'
              : 'A comprehensive operational manual to help you efficiently study ASHRAE standards 52.2, 52.2-2017, 55, 62.1, 62.1-2022, and 90.1 using the complete 439 bilingual question bank.'
            }
          </div>
            ...
            <div className="card card-hover" style={{ borderLeft: '5px solid var(--clr-primary-500)', padding: '1.75rem' }}>
              <div className="flex items-center gap-3 mb-3" style={{ marginBottom: '1rem' }}>
                ...
                <div>
                  ...
                  <div className="text-sm text-muted">Ngân hàng 439 câu hỏi VSCD 2026 chính thức song ngữ Anh – Việt</div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.25rem', marginTop: '1.25rem' }}>
                <div style={{ background: 'var(--clr-primary-50)', padding: '1.25rem', borderRadius: 'var(--radius-lg)', border: '1px solid var(--clr-primary-100)' }}>
                  ...
                  <p style={{ fontSize: '0.92rem', color: 'var(--clr-neutral-700)', lineHeight: '1.6' }}>
                    Cho phép làm tuần tự từ Q001 đến Q439 theo đúng trình tự sách thi của ASHRAE. Bạn có thể bấm chọn riêng từng <strong>Cấp độ nhận thức Bloom</strong> (<em>Remember, Understand, Apply, Analyze, Evaluate, Create</em>) hoặc thi chuyên sâu vào các tiêu chuẩn con bên dưới (ASHRAE 52.2, 52.2-2017, 55, 62.1, 62.1-2022, 90.1).
                  </p>
