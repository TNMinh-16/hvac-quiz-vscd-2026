...
của toàn bộ 304 câu hỏi trong data/questions.json theo đúng Yêu cầu số 1.
"""
...
def verify_snapshot():
    ...
    print("XÁC MINH THÀNH CÔNG: Toàn bộ 304 câu hỏi và các trường dữ liệu khớp 100% với snapshot gốc!")
